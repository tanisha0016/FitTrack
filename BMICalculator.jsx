...
const BMICalculator = () => {
  ...
  const calculateBMI=(e)=>{
    ...
    if(bmiValue<18.5){
      toast.warning("You are underweight. Consider taking advice from a Healthcare provider.");
    }
    else if(bmiValue>=18.5 && bmiValue<24.9){
      toast.success("You have a normal weight. Keep maintaining a healthy lifestyle.");
    }
    else if(bmiValue>=25 && bmiValue<29.9){
      toast.warning("You are overweight. Consider taking advice from a Healthcare provider.");
    }
    else{
